            ...
            <div class="insert">
                <form action="/login" method="get">
                    <div>
                        ...
                        <span><input type="text" name="uName" id="uName" value="root" class="textbox" autocomplete="off"></span>
                    </div>
                    <div>
                        <span style="text-align: left"; text-indent: 0.4em><label>密码</label></span>
                        <span><input type="password" name="uPassword" id="uPassword" value="root" class="password"></span>
                    </div>
                    <div class="sign">
